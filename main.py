...
p = p1.pegasos(train_bow_features, train_labels, T = T, L = L)
best_theta = p[0]
...
# print(dic)
# print(dictionary)
# def dictionary_stop_word_removal(dic, dic_to_remove):
#     new_dictionary = {}
#     for key, value in dic.items():
#         for k, v in dic_to_remove.items():
#             if key != k:
...
#
#
# def dictionary_stop_word_removal(dic):
#     desired_key = 'tradder'
#     for key, value in dic.items():
#         if key == desired_key:
#             del dic[key]
...
#     return dic
#
# x = dictionary_stop_word_removal(dictionary, dic)
# print(x)